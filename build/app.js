...
var _user$project$Update$currentPlayerWinning = F2(
	function (currentPlayer, boxes) {
		var checkPlayerPositionsInList = F3(
		...
		return !_elm_lang$core$List$isEmpty(
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (indices) {
						return A3(checkPlayerPositionsInList, currentPlayer, indices, boxes);
					},
...
var _user$project$View$view = function (model) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$View$class(
					{
						ctor: '::',
						_0: _user$project$CssTypes$Footer,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
	...
	var boxAttributes = function (index) {
		var _p1 = A2(_elm_lang$core$Array$get, index, model.boxes);
		if (_p1.ctor === 'Just') {
			if (_p1._0._0.ctor === 'Unclaimed') {
				return {
					ctor: '_Tuple2',
					_0: _user$project$Player$Unclaimed,
					_1: {
		...
		return function (_p2) {
			...
			return A2(
						...
						_0: _user$project$View$class(
							{
								...
								_1: {
									ctor: '::',
									_0: _user$project$CssTypes$PlayerColor(_p4),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					...
					_p3._1),
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_user$project$Player$showPlayer(_p4)),
					_1: {ctor: '[]'}
				});
		}(
			boxAttributes(index));
			...
			if (_p5._0.ctor === 'Unclaimed') {
				...
				return showDeadEnd(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Player$showPlayer(_p5._0),
							' wins!')));
			}
		}
	}();
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Tic Tac Toe in Elm'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
